...
type KubeletConfiguration struct {
	...
	// Maximum number of concurrent log rotate workers to spawn for processing the log rotation
	// requests
	ContainerLogMaxWorkers int32
	// Duration at which the container logs are monitored for rotation
	ContainerLogMonitorPeriod metav1.Duration
