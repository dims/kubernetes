...
import (
	...
	"k8s.io/kubernetes/third_party/forked/cadvisor/cache/memory"
	"k8s.io/kubernetes/third_party/forked/cadvisor/collector"
	"k8s.io/kubernetes/third_party/forked/cadvisor/container"
	"k8s.io/kubernetes/third_party/forked/cadvisor/container/raw"
	"k8s.io/kubernetes/third_party/forked/cadvisor/events"
	"k8s.io/kubernetes/third_party/forked/cadvisor/fs"
	info "k8s.io/kubernetes/third_party/forked/cadvisor/info/v1"
	v2 "k8s.io/kubernetes/third_party/forked/cadvisor/info/v2"
	"k8s.io/kubernetes/third_party/forked/cadvisor/machine"
	"k8s.io/kubernetes/third_party/forked/cadvisor/nvm"
	"k8s.io/kubernetes/third_party/forked/cadvisor/perf"
	"k8s.io/kubernetes/third_party/forked/cadvisor/resctrl"
	"k8s.io/kubernetes/third_party/forked/cadvisor/stats"
	"k8s.io/kubernetes/third_party/forked/cadvisor/utils/oomparser"
	"k8s.io/kubernetes/third_party/forked/cadvisor/utils/sysfs"
	"k8s.io/kubernetes/third_party/forked/cadvisor/version"
	"k8s.io/kubernetes/third_party/forked/cadvisor/watcher"
