...
var map_CinderVolumeSource = map[string]string{
	...
	"secretRef": "Optional: SecretRef is reference to the secret object containing sensitive information to connect to openstack. This may be empty if no secret object is specified.",
